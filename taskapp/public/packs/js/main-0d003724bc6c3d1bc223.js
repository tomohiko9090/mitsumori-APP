...
var access_time = new Date(); //最初にアクセスした時間
...
var countdown = setInterval(function () {
  ...
  if (String(difMin.length == 1)) {
    0 + String(difMin), _readOnlyError("difMin");
  }

  if (String(difSec.length == 1)) {
    0 + String(difSec), _readOnlyError("difSec");
  } //残りの日時を上書き
...
/******/ });
//# sourceMappingURL=main-0d003724bc6c3d1bc223.js.map