...
class Faker::ChileRut < Faker::Base
  ...
  def self.dv; end
  def self.full_rut(min_rut: nil, fixed: nil, formatted: nil); end
...
class Faker::Fillmurray < Faker::Base
  def self._deprecated_image(grayscale: nil, width: nil, height: nil); end
  def self.image(*args, &block); end
end
...
class InvalidName___Class_0x00___UnavailableInEra_41 < StandardError
end
